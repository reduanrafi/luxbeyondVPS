            ...
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden lg:flex flex-1 max-w-2xl mx-8 relative">
                    ...
                    >
                        ...
                        <div v-else-if="searchResults.length > 0" class="py-2">
                            ...
                            >
                                <img 
                                    :src="product.image_url ? product.image_url : '/assets/placeholder.png'"
                                    :alt="product.name"
                                    class="w-16 h-16 object-cover rounded-lg border border-gray-200"
                                />
                                <div class="flex-1 min-w-0">
                                    <h4 class="text-sm font-medium text-gray-900 group-hover:text-primary transition-colors truncate">
                                        {{ product.name }}
                                    </h4>
                                    <p class="text-xs text-gray-500 mt-1">{{ product.category }}</p>
                                    <p class="text-sm font-semibold text-primary mt-1">
                                        ${{ product.sellable_price || product.price }}
                                    </p>
                                </div>
                            </router-link>
                        </div>
                ...
                <div class="hidden lg:flex items-center space-x-3 ml-6 pl-6 border-l border-gray-200">
                    ...
                    <router-link 
                        v-if="!authStore.isAuthenticated" 
                        to="/login"
                        class="px-4 py-2 text-sm font-medium text-gray-700 hover:text-primary transition-colors"
                    >
                        Login
                    </router-link>
                    <router-link 
...
import { ShoppingCart, Heart, Menu, X, Bell, Search } from 'lucide-vue-next';
