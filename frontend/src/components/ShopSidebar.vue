<template>
    <aside class="w-80 flex-shrink-0 hidden lg:block bg-white border-r border-gray-200">
        <div class="fixed w-80">
            <!-- Header -->
            <div class="border-b border-gray-200 px-4 py-3 text-white">
            ...
            <div class="p-2 max-h-[calc(100vh-120px)] overflow-y-auto">
                ...
                <button @click="selectCategory(null)"
                    ...
                    class="w-full flex items-center gap-3 px-3 py-2.5 transition-all text-left font-medium border border-gray-200 mb-2 rounded-lg">
                    All Categories
                </button>
